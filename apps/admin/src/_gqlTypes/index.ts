...
export type AttributeDetailsTreeAttributeFragment = { id: string, type: AttributeType, format?: AttributeFormat | null, system: boolean, readonly: boolean, required: boolean, label?: any | null, description?: any | null, multiple_values: boolean, multi_link_display_option?: MultiDisplayOption | null, multi_tree_display_option?: MultiDisplayOption | null, settings?: any | null, linked_tree?: { id: string } | null, metadata_fields?: Array<{ id: string, label?: any | null, type: AttributeType, format?: AttributeFormat | null }> | null, permissions_conf?: { relation: PermissionsRelation, permissionTreeAttributes: Array<{ id: string, label?: any | null } | { id: string, label?: any | null, linked_tree?: { id: string } | null }> } | null, versions_conf?: { versionable: boolean, mode?: ValueVersionMode | null, profile?: { id: string, label: any, trees: Array<{ id: string, label?: any | null }> } | null } | null, libraries?: Array<{ id: string, label?: any | null }> | null };
...
export type SavePermissionMutation = { savePermission: { type: PermissionTypes, applyTo?: string | null, usersGroup?: string | null, actions: Array<{ name: PermissionsActions, allowed?: boolean | null }>, permissionTreeTarget?: { nodeId?: string | null, tree: string } | null } };
...
export const GetPermissionsDocument = gql`
    query GET_PERMISSIONS($type: PermissionTypes!, $applyTo: ID, $actions: [PermissionsActions!]!, $usersGroup: ID, $permissionTreeTarget: PermissionsTreeTargetInput) {
  perm: permissions(
    type: $type
    applyTo: $applyTo
    actions: $actions
