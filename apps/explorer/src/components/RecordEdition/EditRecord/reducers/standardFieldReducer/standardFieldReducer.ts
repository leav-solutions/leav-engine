...
import {AnyPrimitive, IKeyValue} from '@leav/utils';
...
import {IDateRangeValue, IValueVersion} from '_types/types';
...
const _computeScopeAndValues = (params: {
    ...
    const preparedValues: IKeyValue<IStandardFieldValue> =
    ...
    switch (action.type) {
        ...
        case StandardFieldReducerActionsTypes.UPDATE_AFTER_SUBMIT: {
            ...
            const newValueData = {
                ...
                value: ({
                    ...(action.newValue as SAVE_VALUE_BATCH_saveValueBatch_values_Value),
