...
export type SAVE_VALUE_BATCH_saveValueBatch_values = SAVE_VALUE_BATCH_saveValueBatch_values_Value | SAVE_VALUE_BATCH_saveValueBatch_values_LinkValue | SAVE_VALUE_BATCH_saveValueBatch_values_TreeValue;
