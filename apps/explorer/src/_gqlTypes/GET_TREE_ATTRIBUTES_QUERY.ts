...
export interface GET_TREE_ATTRIBUTES_QUERY_trees_list_libraries_library_attributes_StandardAttribute {
  ...
  embedded_fields: (GET_TREE_ATTRIBUTES_QUERY_trees_list_libraries_library_attributes_StandardAttribute_embedded_fields | null)[] | null;
}
...
export type GET_TREE_ATTRIBUTES_QUERY_trees_list_libraries_library_attributes = GET_TREE_ATTRIBUTES_QUERY_trees_list_libraries_library_attributes_StandardAttribute | GET_TREE_ATTRIBUTES_QUERY_trees_list_libraries_library_attributes_LinkAttribute | GET_TREE_ATTRIBUTES_QUERY_trees_list_libraries_library_attributes_TreeAttribute;
