...
describe('constants', () => {
    ...
    describe('with empty base URL', () => {
        ...
        it('should set APP_BASE_URL without trailing slash', () => {
            expect(constants.APP_BASE_URL).toBe('/app/app-studio');
        });

        it('should set APP_ENDPOINT to last segment of APP_BASE_URL', () => {
            expect(constants.APP_ENDPOINT).toBe('app-studio');
        });
    ...
    describe('with /campaigns-manager base URL', () => {
        ...
        it('should set APP_BASE_URL without trailing slash', () => {
            expect(constants.APP_BASE_URL).toBe('/campaigns-manager/app/app-studio');
        });
