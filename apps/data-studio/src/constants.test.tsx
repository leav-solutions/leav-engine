...
describe('constants', () => {
    ...
    describe('with empty base URL', () => {
        beforeAll(async () => {
            ...
            window.__dynamic_base__ = '/app/data-studio';
        ...
        it('should set APP_BASE_URL without trailing slash', () => {
            expect(constants.APP_BASE_URL).toBe('/app/data-studio');
        });

        it('should set APP_ENDPOINT to last segment of APP_BASE_URL', () => {
            expect(constants.APP_ENDPOINT).toBe('data-studio');
        });
    ...
    describe('with /campaigns-manager base URL', () => {
        beforeAll(async () => {
            ...
            window.__dynamic_base__ = '/campaigns-manager/app/data-studio';
        ...
        it('should set APP_BASE_URL without trailing slash', () => {
            expect(constants.APP_BASE_URL).toBe('/campaigns-manager/app/data-studio');
        });
