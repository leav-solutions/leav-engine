...
module.exports = {
    ...
    coreModes:
        // keep retrocompatibility with CORE_MODE env variable, but CORE_MODES is now the main way to set core modes and support multiple modes at the same time
        process.env.CORE_MODE ? [process.env.CORE_MODE] : envToStringArray(process.env.CORE_MODES, ',', []),
    server: {
    ...
    auth: {
        ...
        cookie: {
            ...
            withDomain: envToBool(process.env.AUTH_COOKIE_WITH_DOMAIN, false),
        },
