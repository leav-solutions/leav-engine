...
| `@types/jexl`                                                                        | Le code importe `jexl-extended`, pas `jexl` — mais `jexl-extended/dist/index.d.ts` fait `import {Jexl} from 'jexl'` et `jexl@2` n'embarque aucun typage. Sans ce `@types`, `tscheck` casse.                                                                          |
