...
export const databaseEventsCounter: Counter = meter.createCounter('events.database.sent.total', {
    description:
...
export const databaseEventPayloadSize: Histogram = meter.createHistogram('events.database.payload.size', {
    description:
...
export const databaseEventPublishDuration: Histogram = meter.createHistogram('events.database.publish.duration', {
    description:
