...
export default function ({
    ...
    return {
        ...
        async saveVersionProfile({versionProfile, ctx}) {
            ...
            await eventsManagerDomain.sendDatabaseEvent<EventAction.VERSION_PROFILE_SAVE>(
                {
        ...
        async deleteVersionProfile({id, ctx}) {
            ...
            await eventsManagerDomain.sendDatabaseEvent<EventAction.VERSION_PROFILE_DELETE>(
                {
