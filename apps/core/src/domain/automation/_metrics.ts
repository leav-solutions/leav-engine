...
export const triggerCounter: Counter = meter.createCounter('automation.trigger.total', {
    description:
        'Number of domain events evaluated for automation rules. `outcome` reports whether any active rule matched the event.',
});

export const triggerRulesMatched: Histogram = meter.createHistogram('automation.trigger.rules_matched', {
    description: 'Distribution of the number of automation rules matched per incoming event.',
});

export const triggerDuration: Histogram = meter.createHistogram('automation.trigger.duration', {
    description:
...
export const triggerRulesFetchDuration: Histogram = meter.createHistogram('automation.trigger.rules_fetch.duration', {
    description:
