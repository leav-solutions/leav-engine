...
describe('Utils', () => {
    ...
    describe('areValuesIdentical', () => {
        ...
        test('should return false if values are different', () => {
            const utilsModule = utils();
            const value1: IValue = {payload: 'hello', metadata: {foo: 'bar'}};
            const value2: IValue = {payload: 'world', metadata: {foo: 'bar'}};
        ...
        test('should return false if metadata is different', () => {
            const utilsModule = utils();
            const value1: IValue = {payload: 'hello', metadata: {foo: 'bar'}};
            const value2: IValue = {payload: 'hello', metadata: {bar: 'baz'}};
            expect(utilsModule.areValuesIdentical(value1, value2)).toBe(false);

            const value3: IValue = {payload: 'hello'};
            const value4: IValue = {payload: 'hello', metadata: {bar: 'baz'}};
        ...
        test('should return false if both values and metadata are different', () => {
            const utilsModule = utils();
            const value1: IValue = {payload: 'hello', metadata: {foo: 'bar'}};
            const value2: IValue = {payload: 'world', metadata: {bar: 'baz'}};
            expect(utilsModule.areValuesIdentical(value1, value2)).toBe(false);
        });
        ...
        test('should return false if one of the values is null or undefined', () => {
            const utilsModule = utils();
            const value1: IValue = {payload: 'hello', metadata: {foo: 'bar'}};
            const value2: IValue = {payload: null, metadata: {foo: 'bar'}};
            expect(utilsModule.areValuesIdentical(value1, value2)).toBe(false);

            const value3: IValue = {payload: 'hello', metadata: {foo: 'bar'}};
            const value4: IValue = {payload: undefined, metadata: {foo: 'bar'}};
            expect(utilsModule.areValuesIdentical(value3, value4)).toBe(false);

            const value5: IValue = {payload: null, metadata: {foo: 'bar'}};
            const value6: IValue = {payload: undefined, metadata: {foo: 'bar'}};
