    ...
    describe('areValuesIdentical', () => {
        describe('simple attribute', () => {
            test('should return true if values and metadata are identical', () => {
                ...
                expect(utilsModule.areValuesIdentical(mockAttrSimple, value1, value2)).toBe(true);

                const value3: IValue = {payload: 'hello'};
                const value4: ISaveValue = {payload: 'hello'};
                expect(utilsModule.areValuesIdentical(mockAttrSimple, value3, value4)).toBe(true);
            });
            ...
            test('should return false if values are different', () => {
                ...
                expect(utilsModule.areValuesIdentical(mockAttrSimple, value1, value2)).toBe(false);
            });
            ...
            test('should return false if metadata is different', () => {
                ...
                expect(utilsModule.areValuesIdentical(mockAttrSimple, value3, value4)).toBe(false);
            });
            ...
            test('should return true if metadata are falsy on both values', () => {
                ...
                expect(utilsModule.areValuesIdentical(mockAttrSimple, value5, value6)).toBe(true);

                const value7: IValue = {payload: 'hello', metadata: {}};
                const value8: ISaveValue = {payload: 'hello', metadata: null};
                expect(utilsModule.areValuesIdentical(mockAttrSimple, value7, value8)).toBe(true);

                const value9: IValue = {payload: 'hello'};
                const value10: ISaveValue = {payload: 'hello', metadata: null};
                expect(utilsModule.areValuesIdentical(mockAttrSimple, value9, value10)).toBe(true);
            });
            ...
            test('should return false if one of the values is null or undefined', () => {
                ...
                expect(utilsModule.areValuesIdentical(mockAttrSimple, value5, value6)).toBe(false);
            });
        });
    });
});
