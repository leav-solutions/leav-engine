...
export enum Errors {
    ...
    CANNOT_SAVE_TREE_SELECTION_CONF = 'CANNOT_SAVE_TREE_SELECTION_CONF',
    ...
    INVALID_COLUMN_SPLIT_CONF = 'INVALID_COLUMN_SPLIT_CONF',
    INVALID_NESTED_ATTRIBUTE_PATH = 'INVALID_NESTED_ATTRIBUTE_PATH',
    ...
    INVALID_TREE_SELECTION_CONF = 'INVALID_TREE_SELECTION_CONF',
