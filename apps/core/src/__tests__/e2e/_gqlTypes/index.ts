...
export type SaveApiKeyMutation = {
    saveApiKey: {id: string; label?: string | null; key?: string | null; expiresAt?: number | null; user: {id: string}};
};
...
export type CreateRecordMutation = {
    createRecord: {
        valuesErrors?: Array<{attribute: string; input?: string | null; message: string; type: string}> | null;
...
export type SaveValueBatchMutation = {
    saveValueBatch: {
        errors?: Array<{attribute: string; input?: string | null; message: string; type: string}> | null;
        values?: Array<
