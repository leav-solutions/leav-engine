...
export type SaveAttributeMutation = {saveAttribute: {id: string; column_split_enabled?: boolean | null}};
...
export type GetLinkAttributeSmartFilterQuery = {
    attributes?: {list: Array<{smart_filter?: {enable: boolean; through?: {id: string} | null} | null}>} | null;
};
    ...
    automationRules: {
        list: Array<{
            ...
            trigger: {
                synchronous: boolean;
                eventAction: AutomationRuleEventAction;
                eventTopic?: {library?: string | null} | null;
            };
            pipeline: {steps: Array<{type: AutomationRuleActions; name?: string | null; params: any}>};
        }>;
    };
};
...
export type GetRecordsLinkValuesPropertyQuery = {
    records: {
        list: Array<{
            id: string;
            active: boolean;
            whoAmI: {library: {id: string}};
            property: Array<{id_value?: string | null; linkPayload?: {id: string} | null} | {id_value?: string | null}>;
        }>;
    };
};
...
export type NotificationsQuery = {
    notifications: {
        ...
        list: Array<{
            ...
            message: string;
            taskId?: string | null;
            relatedEntities?: Array<{url: string; label: string}> | null;
            attachments?: Array<{url: string; label: string}> | null;
        }>;
    };
};
...
export type GetRecordWithSystemPropertiesQuery = {
    records: {
        list: Array<{
            id: string;
            active: boolean;
...
export type CreateRecordMutation = {
    createRecord: {
        valuesErrors?: Array<{attribute?: string | null; input?: string | null; message: string; type: string}> | null;
        record?: {id: string; uuid: string} | null;
    };
};
...
export type GetRecordByUuidQuery = {
    records: {
        list: Array<{
            id: string;
            uuid: string;
            ...
            created_at: number;
            modified_at: number;
            created_by: Array<{payload?: {id: string} | null}>;
            modified_by: Array<{payload?: {id: string} | null}>;
            whoAmI: {label?: string | null};
        }>;
    };
};
...
export type SaveValueBatchMutation = {
    saveValueBatch: {
        errors?: Array<{attribute?: string | null; input?: string | null; message: string; type: string}> | null;
        values?: Array<
...
export type GetRecordByIdStandardValuesPropertyQuery = {
    records: {
        list: Array<{
            id: string;
            active: boolean;
            whoAmI: {library: {id: string}};
            property: Array<{id_value?: string | null; payload?: any | null}>;
        }>;
    };
};
...
export type GetRecordByIdLinkValuesPropertyQuery = {
    records: {
        list: Array<{
            id: string;
            active: boolean;
            whoAmI: {library: {id: string}};
            property: Array<{id_value?: string | null; payload?: {id: string; library: {id: string}} | null}>;
        }>;
    };
};
...
export type ListDistinctValuesQuery = {
    listDistinctValues?: Array<{count: number} | {count: number; treeNode?: {id: string} | null}> | null;
};
...
export type GetRecordByIdTreeValuesPropertyQuery = {
    records: {
        list: Array<{
            id: string;
            active: boolean;
            ...
            property: Array<{
                ...
                payload?: {id: string; record: {id: string; library: {id: string}}} | null;
            }>;
        }>;
    };
};
...
export type GetViewsV2Query = {
    viewsV2: {
        ...
        list: Array<{
            ...
            created_by: {id: string; whoAmI: {id: string; label?: string | null}};
            display: {
                type: ViewV2Types;
                settings?: any | null;
                attributes: Array<{visible: boolean; attribute: {id: string}}>;
            };
            filters: Array<{
                pinned: boolean;
            ...
            sorts: Array<{activated: boolean; order: SortOrder; attributes: Array<{id: string}>}>;
        }>;
    };
};
...
export type GetViewV2Query = {
    viewV2: {id: string; created_by: {id: string; whoAmI: {id: string; label?: string | null}}};
};
...
export type UpdateViewV2Mutation = {
    updateViewV2: {id: string; origin?: string | null; display: {type: ViewV2Types; settings?: any | null}};
};
...
export const ExportDocument = gql`
    query Export($library: ID!, $filters: [RecordFilterInput], $searchQuery: String, $profile: String) {
        export(library: $library, filters: $filters, searchQuery: $searchQuery, profile: $profile)
    }
`;
...
export const GetRecordsLinkValuesPropertyDocument = gql`
    query GetRecordsLinkValuesProperty(
        $library: ID!
        $filters: [RecordFilterInput]
        $retrieveInactive: Boolean
        $attribute: ID!
    ) {
        records(library: $library, filters: $filters, retrieveInactive: $retrieveInactive) {
            list {
                id
                whoAmI {
                    library {
...
export const SaveValueBulkDocument = gql`
    mutation SaveValueBulk(
        $libraryId: ID!
        $attributeId: ID!
        $recordsFilters: [RecordFilterInput]
        $searchQuery: String
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        SaveApiKey(
            variables: SaveApiKeyMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SaveApiKeyMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SaveApiKeyMutation>({
                        document: SaveApiKeyDocument,
                        variables,
        ...
        GetApiKeys(
            ...
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetApiKeysQuery>({
        ...
        DeleteApiKey(
            ...
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DeleteApiKeyMutation>({
        ...
        SaveAttribute(
            variables?: SaveAttributeMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SaveAttributeMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SaveAttributeMutation>({
                        document: SaveAttributeDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        DeleteAttribute(
            ...
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<DeleteAttributeMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DeleteAttributeMutation>({
                        document: DeleteAttributeDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        getLinkAttributeSmartFilter(
            variables?: GetLinkAttributeSmartFilterQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetLinkAttributeSmartFilterQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetLinkAttributeSmartFilterQuery>({
                        document: GetLinkAttributeSmartFilterDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetAutomationRules(
            variables?: GetAutomationRulesQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetAutomationRulesQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetAutomationRulesQuery>({
                        document: GetAutomationRulesDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        CreateAutomationRule(
            variables: CreateAutomationRuleMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<CreateAutomationRuleMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<CreateAutomationRuleMutation>({
                        document: CreateAutomationRuleDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        UpdateAutomationRule(
            variables: UpdateAutomationRuleMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<UpdateAutomationRuleMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<UpdateAutomationRuleMutation>({
                        document: UpdateAutomationRuleDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        DuplicateAutomationRule(
            variables: DuplicateAutomationRuleMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<DuplicateAutomationRuleMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DuplicateAutomationRuleMutation>({
                        document: DuplicateAutomationRuleDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        DeleteAutomationRule(
            variables: DeleteAutomationRuleMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<DeleteAutomationRuleMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DeleteAutomationRuleMutation>({
                        document: DeleteAutomationRuleDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        SetAutomationRulesActive(
            variables: SetAutomationRulesActiveMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SetAutomationRulesActiveMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SetAutomationRulesActiveMutation>({
                        document: SetAutomationRulesActiveDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        DeleteAutomationRules(
            variables: DeleteAutomationRulesMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<DeleteAutomationRulesMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DeleteAutomationRulesMutation>({
                        document: DeleteAutomationRulesDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetAutomationRuleForm(
            variables: GetAutomationRuleFormQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetAutomationRuleFormQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetAutomationRuleFormQuery>({
                        document: GetAutomationRuleFormDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        PostDiscussionComment(
            variables?: PostDiscussionCommentMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<PostDiscussionCommentMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<PostDiscussionCommentMutation>({
                        document: PostDiscussionCommentDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        SaveGlobalSettings(
            variables: SaveGlobalSettingsMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SaveGlobalSettingsMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SaveGlobalSettingsMutation>({
                        document: SaveGlobalSettingsDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetRecordsLinkValuesProperty(
            variables: GetRecordsLinkValuesPropertyQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetRecordsLinkValuesPropertyQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetRecordsLinkValuesPropertyQuery>({
                        document: GetRecordsLinkValuesPropertyDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        SaveLibrary(
            variables?: SaveLibraryMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SaveLibraryMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SaveLibraryMutation>({
                        document: SaveLibraryDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        DeleteLibrary(
            variables?: DeleteLibraryMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<DeleteLibraryMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DeleteLibraryMutation>({
                        document: DeleteLibraryDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        SavePermission(
            variables: SavePermissionMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SavePermissionMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SavePermissionMutation>({
                        document: SavePermissionDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetRecord(
            variables: GetRecordQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetRecordQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetRecordQuery>({
                        document: GetRecordDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetRecordWithSystemProperties(
            variables: GetRecordWithSystemPropertiesQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetRecordWithSystemPropertiesQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetRecordWithSystemPropertiesQuery>({
                        document: GetRecordWithSystemPropertiesDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        ActivateNewRecord(
            variables: ActivateNewRecordMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<ActivateNewRecordMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<ActivateNewRecordMutation>({
                        document: ActivateNewRecordDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        DeactivateRecords(
            variables: DeactivateRecordsMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<DeactivateRecordsMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DeactivateRecordsMutation>({
                        document: DeactivateRecordsDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        SearchRecords(
            variables: SearchRecordsQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SearchRecordsQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SearchRecordsQuery>({
        ...
        PurgeInactiveRecords(
            variables: PurgeInactiveRecordsMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<PurgeInactiveRecordsMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<PurgeInactiveRecordsMutation>({
                        document: PurgeInactiveRecordsDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetRecordByUUID(
            variables: GetRecordByUuidQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetRecordByUuidQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetRecordByUuidQuery>({
                        document: GetRecordByUuidDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        SaveTree(
            variables: SaveTreeMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SaveTreeMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SaveTreeMutation>({
                        document: SaveTreeDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        TreeAddElement(
            variables: TreeAddElementMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<TreeAddElementMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<TreeAddElementMutation>({
                        document: TreeAddElementDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        DeleteTree(
            variables: DeleteTreeMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<DeleteTreeMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DeleteTreeMutation>({
                        document: DeleteTreeDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        SaveValueBatch(
            variables?: SaveValueBatchMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SaveValueBatchMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SaveValueBatchMutation>({
                        document: SaveValueBatchDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        SaveValue(
            variables: SaveValueMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SaveValueMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SaveValueMutation>({
                        document: SaveValueDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        DeleteValue(
            ...
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<DeleteValueMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DeleteValueMutation>({
                        document: DeleteValueDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetRecordByIdStandardValuesProperty(
            variables: GetRecordByIdStandardValuesPropertyQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetRecordByIdStandardValuesPropertyQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetRecordByIdStandardValuesPropertyQuery>({
                        document: GetRecordByIdStandardValuesPropertyDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetRecordByIdLinkValuesProperty(
            variables: GetRecordByIdLinkValuesPropertyQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetRecordByIdLinkValuesPropertyQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetRecordByIdLinkValuesPropertyQuery>({
                        document: GetRecordByIdLinkValuesPropertyDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        ListDistinctValues(
            variables: ListDistinctValuesQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<ListDistinctValuesQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<ListDistinctValuesQuery>({
                        document: ListDistinctValuesDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        SaveValueBulk(
            variables: SaveValueBulkMutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<SaveValueBulkMutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<SaveValueBulkMutation>({
                        document: SaveValueBulkDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetRecordByIdTreeValuesProperty(
            variables: GetRecordByIdTreeValuesPropertyQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetRecordByIdTreeValuesPropertyQuery> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetRecordByIdTreeValuesPropertyQuery>({
                        document: GetRecordByIdTreeValuesPropertyDocument,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        CreateViewV2(
            variables: CreateViewV2MutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<CreateViewV2Mutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<CreateViewV2Mutation>({
                        document: CreateViewV2Document,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetViewsV2(
            variables: GetViewsV2QueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetViewsV2Query> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetViewsV2Query>({
                        document: GetViewsV2Document,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        GetViewV2(
            variables: GetViewV2QueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<GetViewV2Query> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<GetViewV2Query>({
                        document: GetViewV2Document,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        UpdateViewV2(
            variables: UpdateViewV2MutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<UpdateViewV2Mutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<UpdateViewV2Mutation>({
                        document: UpdateViewV2Document,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
        ...
        DeleteViewV2(
            variables: DeleteViewV2MutationVariables,
            requestHeaders?: GraphQLClientRequestHeaders,
            signal?: RequestInit['signal'],
        ): Promise<DeleteViewV2Mutation> {
            return withWrapper(
                wrappedRequestHeaders =>
                    client.request<DeleteViewV2Mutation>({
                        document: DeleteViewV2Document,
                        variables,
                        requestHeaders: {...requestHeaders, ...wrappedRequestHeaders},
                        signal,
                    }),
