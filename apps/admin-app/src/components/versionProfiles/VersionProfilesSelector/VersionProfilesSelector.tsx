...
function VersionProfilesSelector(fieldProps: FormDropdownProps): JSX.Element {
    const {loading, error: queryError, data} = useQuery<GET_VERSION_PROFILES, GET_VERSION_PROFILESVariables>(getVersionProfilesQuery);
    ...
    return <VersionProfilesSelectorField {...fieldProps} profiles={profiles} />;
}
