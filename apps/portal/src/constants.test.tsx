...
describe('constants', () => {
    ...
    describe('with empty base URL', () => {
        beforeAll(() => {
            ...
            window.__dynamic_base__ = '/app/portal';
        ...
        it('should set APP_BASE_URL without trailing slash', () => {
            expect(constants.APP_BASE_URL).toBe('/app/portal');
        });

        it('should set APP_ENDPOINT to last segment of APP_BASE_URL', () => {
            expect(constants.APP_ENDPOINT).toBe('portal');
        });
    ...
    describe('with /campaigns-manager base URL', () => {
        beforeAll(() => {
            ...
            window.__dynamic_base__ = '/campaigns-manager/app/portal';
        ...
        it('should set APP_BASE_URL without trailing slash', () => {
            expect(constants.APP_BASE_URL).toBe('/campaigns-manager/app/portal');
        });
