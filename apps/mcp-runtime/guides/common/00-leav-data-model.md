...
Every API call needs the user's **apiKey** — the same key they use in the LEAV UI. It scopes
permissions and attributes every action to that user, so always require it.
