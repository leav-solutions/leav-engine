...
async function loadConfig(dirPath, env) {
    ...
    const merged = _mergeDeep(await _getConfigByEnv(dirPath, 'default'), await _getConfigByEnv(dirPath, env), ignoreLocal ? {} : await _getConfigByEnv(dirPath, 'local'), {
        env
    });
    return merged;
}
__exportStar(require("./envTo"), exports);
