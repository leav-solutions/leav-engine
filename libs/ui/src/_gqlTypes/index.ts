...
export type DetailsApplicationFragment = {
    ...
    icon?: {
        id: string,
        whoAmI: {id: string, label?: string | null, subLabel?: string | null, color?: string | null, preview?: IPreviewScalar | null, library: {id: string, label?: any | null}}
    } | null,
...
export type AttributeDetailsLinkAttributeFragment = {
    ...
    metadata_fields?: Array<{id: string, label?: any | null, type: AttributeType, format?: AttributeFormat | null}> | null,
    versions_conf?: {versionable: boolean, mode?: ValueVersionMode | null, profile?: {id: string, label: any, trees: Array<{id: string, label?: any | null}>} | null} | null,
...
export type AttributesByLibAttributeStandardAttributeFragment = {
    ...
    system: boolean,
    readonly: boolean,
    embedded_fields?: Array<{id: string, format?: AttributeFormat | null, label?: any | null} | null> | null
};
...
export type AttributesByLibAttributeTreeAttributeFragment = {
    ...
    system: boolean,
    readonly: boolean,
    linked_tree?: {id: string, label?: any | null, libraries: Array<{library: {id: string, label?: any | null}}>} | null
};
...
export type RecordFormElementValuesFragment = {
    id: string, valueError?: string | null, values?: Array<{
        ...
        version?: Array<{treeId: string, treeNode?: {id: string, record: {id: string, whoAmI: {id: string, label?: string | null, library: {id: string}}}} | null} | null> | null,
        attribute: {id: string, format?: AttributeFormat | null, type: AttributeType, system: boolean},
        metadata?: Array<{
            name: string,
            value?: {
                id_value?: string | null,
                ...
                version?: Array<{
                    treeId: string,
                    treeNode?: {id: string, record: {id: string, whoAmI: {id: string, label?: string | null, library: {id: string}}}} | null
                } | null> | null
            } | null
        } | null> | null
    } | {
...
export type LibraryDetailsFragment = {
    ...
    } | {id: string, label?: any | null, system: boolean, type: AttributeType, format?: AttributeFormat | null}> | null,
    permissions_conf?: {
        relation: PermissionsRelation,
        permissionTreeAttributes: Array<{id: string, label?: any | null} | {id: string, label?: any | null, linked_tree?: {id: string} | null}>
    } | null,
    recordIdentityConf?: {label?: string | null, subLabel?: string | null, color?: string | null, preview?: string | null, treeColorPreview?: string | null} | null,
    permissions?: {admin_library: boolean, access_library: boolean, access_record: boolean, create_record: boolean, edit_record: boolean, delete_record: boolean} | null,
    icon?: {
        id: string,
        whoAmI: {id: string, label?: string | null, subLabel?: string | null, color?: string | null, preview?: IPreviewScalar | null, library: {id: string, label?: any | null}}
    } | null,
...
export type RecordFormElementFragment = {
    id: string, containerId: string, uiElementType: string, type: FormElementTypes, attribute?: {
        id: string,
        label?: any | null,
        description?: any | null,
        type: AttributeType,
        ...
        multiple_values: boolean,
        compute: boolean,
        linked_library?: {id: string, label?: any | null, behavior: LibraryBehavior, permissions?: {create_record: boolean} | null} | null,
        linkValuesList?: {
            enable: boolean,
        ...
        versions_conf?: {versionable: boolean, profile?: {id: string, trees: Array<{id: string, label?: any | null}>} | null} | null,
        metadata_fields?: Array<{
            ...
            } | {enable: boolean, allowFreeEntry?: boolean | null, allowListUpdate?: boolean | null, values?: Array<string> | null} | null,
    ...
    } | null, settings: Array<{key: string, value: any}>, joinLibraryContext?: {
        mandatoryAttribute: {
            id: string,
            label?: any | null,
            description?: any | null,
...
export type TreeDetailsFragment = {
    ...
    system: boolean,
    libraries: Array<{library: {id: string, label?: any | null}, settings: {allowMultiplePositions: boolean, allowedAtRoot: boolean, allowedChildren: Array<string>}}>
};
...
export type ViewDetailsFragment = {
    ...
    description?: any | null,
    color?: string | null,
    display: {size?: ViewSizes | null, type: ViewTypes},
    ...
    sort?: Array<{field: string, order: SortOrder}> | null,
...
export type LibraryAttributeLinkAttributeFragment = {
    ...
    label?: any | null,
    permissions: {access_attribute: boolean},
    linked_library?: {id: string, label?: any | null, attributes?: Array<{id: string, type: AttributeType, format?: AttributeFormat | null, label?: any | null}> | null} | null
};
...
export type GetAttributesQuery = {
    attributes?: {totalCount: number, list: Array<{id: string, label?: any | null, type: AttributeType, format?: AttributeFormat | null, system: boolean}>} | null
};
...
export type GetVersionableAttributesByLibraryQuery = {
    attributes?: {list: Array<{id: string, versions_conf?: {versionable: boolean, profile?: {id: string, trees: Array<{id: string, label?: any | null}>} | null} | null}>} | null
};
...
export type GetDirectoryDataQuery = {
    records: {
        list: Array<{
            ...
            created_at: Array<{value?: any | null}>,
            created_by: Array<{
                value?: {
                    id: string,
                    whoAmI: {
            ...
            modified_at: Array<{value?: any | null}>,
            modified_by: Array<{
                value?: {
                    id: string,
                    whoAmI: {
            ...
            file_name: Array<{value?: any | null}>,
            file_path: Array<{value?: any | null}>,
...
export type GetLibrariesQuery = {
    libraries?: {list: Array<{id: string, label?: any | null, icon?: {id: string, whoAmI: {id: string, preview?: IPreviewScalar | null, library: {id: string}}} | null}>} | null
};
...
export type GetLibraryPermissionsQuery = {
    libraries?: {list: Array<{permissions?: {access_library: boolean, access_record: boolean, create_record: boolean, edit_record: boolean, delete_record: boolean} | null}>} | null
};
...
export type CreateRecordMutation = {
    createRecord: {
        ...
        valuesErrors?: Array<{type: string, attribute: string, input?: string | null, message: string}> | null
    }
};
...
export type GetFileDataQuery = {
    records: {
        list: Array<{
            ...
            file_name: Array<{value?: any | null}>,
            file_path: Array<{value?: any | null}>,
            previews_status: Array<{value?: any | null}>,
            library: {behavior: LibraryBehavior}
        }>
    }
};
...
export type RecordFormQuery = {
    recordForm?: {
        id: string, recordId?: string | null, library: {id: string}, dependencyAttributes?: Array<{id: string}> | null, elements: Array<{
            id: string, containerId: string, uiElementType: string, type: FormElementTypes, attribute?: {
                id: string,
                label?: any | null,
                description?: any | null,
        ...
        }>, sidePanel?: {enable: boolean, isOpenByDefault?: boolean | null} | null
    } | null
};
...
export type ExplorerAttributesQuery = {
    attributes?: {
        list: Array<{
            ...
            linked_library?: {id: string, label?: any | null} | null,
            permissions: {access_attribute: boolean}
        } | {id: string, type: AttributeType, format?: AttributeFormat | null, label?: any | null, permissions: {access_attribute: boolean}}>
    } | null
};
...
export type ExplorerLibraryDataQuery = {
    records: {
        totalCount?: number | null, list: Array<{
            id: string,
            active: boolean,
            whoAmI: {
                id: string,
            ...
            permissions: {create_record: boolean, delete_record: boolean},
            properties: Array<{
                attributeId: string,
                attributeProperties: {
                    id: string,
...
export type ExplorerLinkDataQuery = {
    records: {
        list: Array<{
            id: string,
            whoAmI: {id: string, library: {id: string}},
            property: Array<{
                id_value?: string | null,
                payload?: {
                    id: string,
        ...
        list: Array<{
            ...
            attributes?: Array<{
                ...
                linked_library?: {
                    id: string,
                    label?: any | null,
                    attributes?: Array<{id: string, type: AttributeType, format?: AttributeFormat | null, label?: any | null}> | null
                } | null,
                permissions: {access_attribute: boolean}
