...
export const RecordFormElementWithValuesFragmentDoc = gql`
    fragment RecordFormElementWithValues on FormElementWithValues {
  id
  containerId
  uiElementType
  attribute {
...
export const GetRecordFormElementsValuesDocument = gql`
  ...
  getRecordFormElementsValues(
    ...
    ...RecordFormElementWithValues
  }
}
    ${RecordFormElementWithValuesFragmentDoc}`;
 ...
 * });
 */
export function useGetRecordFormElementsValuesQuery(baseOptions: Apollo.QueryHookOptions<GetRecordFormElementsValuesQuery, GetRecordFormElementsValuesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRecordFormElementsValuesQuery, GetRecordFormElementsValuesQueryVariables>(GetRecordFormElementsValuesDocument, options);
      }
export function useGetRecordFormElementsValuesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRecordFormElementsValuesQuery, GetRecordFormElementsValuesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRecordFormElementsValuesQuery, GetRecordFormElementsValuesQueryVariables>(GetRecordFormElementsValuesDocument, options);
        }
