        ...
        list: Array<{
            ...
            properties: Array<{
                ...
                values: Array<
                    ...
                    | {valuePayload?: any | null; attribute: {type: AttributeType}}
                >;
            }>;
        }>;
    };
 ...
 * });
 */
export function useUploadUpdateSubscription(
    baseOptions?: Apollo.SubscriptionHookOptions<UploadUpdateSubscription, UploadUpdateSubscriptionVariables>
) {
    const options = {...defaultOptions, ...baseOptions};
    return Apollo.useSubscription<UploadUpdateSubscription, UploadUpdateSubscriptionVariables>(
 ...
 * });
 */
export function useGetLibraryPreviewsSettingsQuery(
    baseOptions: Apollo.QueryHookOptions<GetLibraryPreviewsSettingsQuery, GetLibraryPreviewsSettingsQueryVariables>
) {
    const options = {...defaultOptions, ...baseOptions};
    return Apollo.useQuery<GetLibraryPreviewsSettingsQuery, GetLibraryPreviewsSettingsQueryVariables>(
        GetLibraryPreviewsSettingsDocument,
        options
    );
}
export function useGetLibraryPreviewsSettingsLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetLibraryPreviewsSettingsQuery, GetLibraryPreviewsSettingsQueryVariables>
) {
    const options = {...defaultOptions, ...baseOptions};
    return Apollo.useLazyQuery<GetLibraryPreviewsSettingsQuery, GetLibraryPreviewsSettingsQueryVariables>(
        GetLibraryPreviewsSettingsDocument,
        options
    );
}
...
export type GetLibraryPreviewsSettingsQueryResult = Apollo.QueryResult<
    GetLibraryPreviewsSettingsQuery,
 ...
 * });
 */
export function useRecordUpdateSubscription(
    baseOptions?: Apollo.SubscriptionHookOptions<RecordUpdateSubscription, RecordUpdateSubscriptionVariables>
) {
    const options = {...defaultOptions, ...baseOptions};
    return Apollo.useSubscription<RecordUpdateSubscription, RecordUpdateSubscriptionVariables>(
 ...
 * });
 */
export function useRunActionsListAndFormatOnValueQuery(
    baseOptions: Apollo.QueryHookOptions<
        RunActionsListAndFormatOnValueQuery,
        RunActionsListAndFormatOnValueQueryVariables
    >
) {
    const options = {...defaultOptions, ...baseOptions};
    return Apollo.useQuery<RunActionsListAndFormatOnValueQuery, RunActionsListAndFormatOnValueQueryVariables>(
        RunActionsListAndFormatOnValueDocument,
        options
    );
}
export function useRunActionsListAndFormatOnValueLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<
        RunActionsListAndFormatOnValueQuery,
        RunActionsListAndFormatOnValueQueryVariables
    >
    ...
    const options = {...defaultOptions, ...baseOptions};
    return Apollo.useLazyQuery<RunActionsListAndFormatOnValueQuery, RunActionsListAndFormatOnValueQueryVariables>(
        RunActionsListAndFormatOnValueDocument,
        options
    );
}
export type RunActionsListAndFormatOnValueQueryHookResult = ReturnType<typeof useRunActionsListAndFormatOnValueQuery>;
export type RunActionsListAndFormatOnValueLazyQueryHookResult = ReturnType<
    typeof useRunActionsListAndFormatOnValueLazyQuery
>;
export type RunActionsListAndFormatOnValueQueryResult = Apollo.QueryResult<
    RunActionsListAndFormatOnValueQuery,
    RunActionsListAndFormatOnValueQueryVariables
>;
