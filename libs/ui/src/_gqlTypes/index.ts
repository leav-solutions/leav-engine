...
export function useGetRecordFormElementsValuesSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<GetRecordFormElementsValuesQuery, GetRecordFormElementsValuesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetRecordFormElementsValuesQuery, GetRecordFormElementsValuesQueryVariables>(GetRecordFormElementsValuesDocument, options);
        }
