...
export type LibraryPreviewsSettingsFragment = { id: string, label: any, description?: any | null, system: boolean, versions: { background: string, density: number, sizes: Array<{ name: string, size: number }> } };
...
export type GetLibrariesLightQuery = { libraries?: { list: Array<{ id: string, label?: any | null, icon?: { id: string, whoAmI: { id: string, preview?: IPreviewScalar | null, library: { id: string } } } | null }> } | null };
...
export type GetLibrariesListQuery = { libraries?: { list: Array<{ id: string, label?: any | null, behavior: LibraryBehavior, icon?: { id: string, whoAmI: { id: string, label?: string | null, subLabel?: string | null, color?: string | null, preview?: IPreviewScalar | null, library: { id: string, label?: any | null } } } | null, gqlNames: { query: string, filter: string, searchableFields: string }, previewsSettings?: Array<{ id: string, description?: any | null, label: any, system: boolean, versions: { background: string, density: number, sizes: Array<{ name: string, size: number }> } }> | null, permissions?: { access_library: boolean, access_record: boolean, create_record: boolean, edit_record: boolean, delete_record: boolean } | null }> } | null };
 ...
 * });
 */
export function useGetLibrariesLightQuery(baseOptions?: Apollo.QueryHookOptions<GetLibrariesLightQuery, GetLibrariesLightQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLibrariesLightQuery, GetLibrariesLightQueryVariables>(GetLibrariesLightDocument, options);
      }
export function useGetLibrariesLightLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLibrariesLightQuery, GetLibrariesLightQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLibrariesLightQuery, GetLibrariesLightQueryVariables>(GetLibrariesLightDocument, options);
        }
