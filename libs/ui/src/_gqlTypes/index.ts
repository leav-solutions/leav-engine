...
export type DetailsApplicationFragment = { id: string, label: any, type: ApplicationType, description?: any | null, endpoint?: string | null, url?: string | null, color?: string | null, module?: string | null, settings?: any | null, icon?: { id: string, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } } | { id: string, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } } | { id: string, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } } | null, permissions: { access_application: boolean, admin_application: boolean } };

export type RecordIdentityIU6KUklmeZsEiE0uJWu3jwvY6KvjHkkYfqO6CbC1MFragment = { id: string, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } };

export type RecordIdentityWriHjucyvtOb6vgRGmHm1fTqX6y6kDl4ccXvOx1Ft74Fragment = { id: string, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } };

export type RecordIdentityZzzzzzFragment = { id: string, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } };

export type RecordIdentityFragment = RecordIdentityIU6KUklmeZsEiE0uJWu3jwvY6KvjHkkYfqO6CbC1MFragment | RecordIdentityWriHjucyvtOb6vgRGmHm1fTqX6y6kDl4ccXvOx1Ft74Fragment | RecordIdentityZzzzzzFragment;
...
export type GetAttributesQuery = { attributes?: { list: Array<{ id: string, label?: any | null, type: AttributeType, format?: AttributeFormat | null }> } | null };
...
export type GetLibrariesQuery = { libraries?: { list: Array<{ id: string, label?: any | null, icon?: { id: string, whoAmI: { id: string, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string } } } | { id: string, whoAmI: { id: string, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string } } } | { id: string, whoAmI: { id: string, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string } } } | null }> } | null };
...
export type GetLibraryByIdQuery = { libraries?: { list: Array<{ id: string, label?: any | null, behavior: LibraryBehavior, system?: boolean | null, fullTextAttributes?: Array<{ id: string, label?: any | null }> | null, attributes?: Array<{ id: string, label?: any | null, system: boolean, type: AttributeType, format?: AttributeFormat | null, linked_library?: { id: string, behavior: LibraryBehavior } | null } | { id: string, label?: any | null, system: boolean, type: AttributeType, format?: AttributeFormat | null }> | null, permissions_conf?: { relation: PermissionsRelation, permissionTreeAttributes: Array<{ id: string, label?: any | null } | { id: string, label?: any | null, linked_tree?: { id: string } | null }> } | null, recordIdentityConf?: { label?: string | null, color?: string | null, preview?: string | null, treeColorPreview?: string | null } | null, permissions?: { admin_library: boolean, access_library: boolean, access_record: boolean, create_record: boolean, edit_record: boolean, delete_record: boolean } | null, icon?: { id: string, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } } | { id: string, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } } | { id: string, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } } | null, previewsSettings?: Array<{ label: any, description?: any | null, system: boolean, versions: { background: string, density: number, sizes: Array<{ name: string, size: number }> } }> | null }> } | null };
...
export type UserInfoQuery = { me?: { id: string, login?: string | null, whoAmI: { id: string, label?: string | null, color?: string | null, preview?: IPreviewScalar<RecordIdentityFragment> | null, library: { id: string, label?: any | null } } } | null, permissions?: Array<{ name: PermissionsActions, allowed?: boolean | null }> | null };
