 ...
 * @param onReplace - callback to let outside world know about linking feedback
...
export const useReplaceLinkMassAction = ({
    ...
    linkId?: string;
    onReplace?: (saveValuesResult: ISubmitMultipleResult) => void;
    closeModal: () => void;
}) => {
