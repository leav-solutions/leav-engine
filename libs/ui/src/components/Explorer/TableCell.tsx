...
// `size="s"` on a KitAvatar resolves to 24px. The group needs that same value in antd units:
// the "+N" overflow avatar is generated by antd itself and reads its size from the group
// context, never from the children - KitAvatar.Group does not carry the Kit size scale.
const avatarGroupSize = 24;
    ...
    if (attributeProperties.multiple_values) {
        if (isStandardValues(values, attributeProperties)) {
            ...
            switch (attributeProperties.multi_link_display_option) {
                ...
                default:
                    return (
                        <KitAvatar.Group max={{count: 5}} size={avatarGroupSize}>
