...
export const useLinkRecordsInEdition = ({
    ...
    const _getExplorerItemActions = (): Array<'edit' | 'remove'> => {
        ...
        return attribute.multiple_values && backendValues.length > 1 && attribute.required ? undefined : ['edit'];
    };
            ...
            <>
                ...
                <LinkActionsButtons
                    ...
                    linkButtonProps={{
                        ...
                        disabled: isReadOnly || (attribute.multiple_values && explorerActions?.createAction?.disabled) //TODO: Should be fixed by explorer team
                    }}
