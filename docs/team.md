# Équipe & contacts — LEAV

Annuaire factuel des personnes intervenant autour de LEAV : rôle officiel et périmètre.
Sert à router une question ou une demande vers le bon interlocuteur.

> Centré LEAV. Les personnes travaillant surtout sur les produits/apps voisins (AMP, xStream,
> Campaigns Manager, Offers Manager, design-system) sont listées avec leur périmètre pour situer
> les responsabilités, sans détailler ces produits ici.

## Engineering — management

| Personne              | Rôle                                                  | Contact              |
| --------------------- | ----------------------------------------------------- | -------------------- |
| Cédric Eymard-Vernein | Head of Engineering — manage les devs, contact Zenika | c.eymard@aristid.com |
...
| Jérémy Bel           | Back / core                                              | j.bel@aristid.com             |
| Nicolas Sourimant    | Full-stack (LEAV & xStream)                              | n.sourimant@aristid.com       |
| Emile Voiron         | Front — design-system (aristid-ds), xStream              | e.voiron-levy@aristid.com     |
| Valentin Bailleul    | Dev (xStream, design-system, LEAV)                       | v.bailleul-ext@aristid.com    |
