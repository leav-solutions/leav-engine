...
The light mode is made for git user that want to quickly checkout on a dev branch and run the project in less than 1 minute.

This light mode will download an artifact automatically generated by GitHub action and run it in a docker container.

The docker-compose.light.yml does not contain admin, login, data-studio and portal services. 
