...
| [ADR-006 — Explorer view config panel](docs/adr/ADR-006-explorer-views-config-panel.md) | État dans le contexte application-settings (pas en search params), communication inter-panneaux via `message-to-panel`, Explorer agnostique d'app-studio, `currentView` prop + `APPLY_SERIALIZED_VIEW`. |
