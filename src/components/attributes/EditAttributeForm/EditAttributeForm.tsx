...
function EditAttributeForm({t, i18n: i18next, errors, attribute, onSubmit}: IEditAttributeFormProps) {
    ...
    const headerLabel =
        existingAttr && formValues.label ? localizedLabel(formValues.label, i18next) : t('attributes.new');
