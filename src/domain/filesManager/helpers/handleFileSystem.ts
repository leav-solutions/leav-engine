...
export const handleEventFileSystem = async (
    ...
    switch (event) {
        case FileEvents.CREATE:
            await handleCreateEvent(scanMsg, resources, deps);
            break;
        case FileEvents.REMOVE:
            await handleRemoveEvent(scanMsg, resources, deps);
            break;
        case FileEvents.UPDATE:
            await handleUpdateEvent(scanMsg, resources, deps);
            break;
        case FileEvents.MOVE:
            await handleMoveEvent(scanMsg, resources, deps);
            break;
        default:
