...
export default (library: ILibrary, isNewLib: boolean, deps: {treeRepo: ITreeRepo; utils: IUtils}): Promise<void> => {
    const actionByBehavior = {
        [LibraryBehavior.FILES]: () => _filesBehavior(library, isNewLib, deps)
    };
